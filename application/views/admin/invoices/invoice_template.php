...
<!--                <div class="form-group mbot15 select-placeholder">
               ...
               <input type="hidden" name="allowed_payment_modes[]" value="stripe">
               ...
               <div class="row">
                  <div class="col-md-6">
                     <?php
                        ...
                        // Deprecated
                        $currency_attr = hooks()->apply_filters('invoice_currency_disabled',$currency_attr);
                  ...
                  <div class="col-md-6">
                     <div class="form-group select-placeholder"<?php if(isset($invoice) && !empty($invoice->is_recurring_from)){ ?> data-toggle="tooltip" data-title="You cannot set this invoice as recurring because this invoice is created from another recurring invoice."<?php } ?>>
                  ...
                  <?php //if((isset($invoice) && $invoice->custom_recurring != 1) || (!isset($invoice))){echo 'hide';} ?>
         ...
         <div class="panel-body bottom-transaction">
            ...
            <div class="btn-bottom-toolbar text-right">
              ...
              <div class="btn-group dropup">
                <button type="button" class="btn-tr btn btn-info invoice-form-submit transaction-submit savebtn"><?php echo _l('submit'); ?></button>
                <button type="button" class="btn btn-info dropdown-toggle savebtn" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                  <span class="caret"></span>
                </button>
